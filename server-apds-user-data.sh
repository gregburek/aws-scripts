...
sudo su - gregburek -c "bash < <(wget --no-check-certificate https://github.com/gregburek/aws-scripts/raw/master/gregburek-env/setup_gregburek.sh -O -)"

sudo passwd -e gregburek
exit 0
